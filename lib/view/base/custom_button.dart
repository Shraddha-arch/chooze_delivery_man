...
class CustomButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ButtonStyle _flatButtonStyle = TextButton.styleFrom(backgroundColor: Colors.white,
      // backgroundColor: onPressed == null ? Theme.of(context).disabledColor : transparent
      //     ? Colors.white : backgroundColor != null ? backgroundColor : Theme.of(context).primaryColor,
    ...
    return Padding(
      padding: margin == null ? EdgeInsets.only(left: 40,right: 40) : margin,
      child: TextButton(
        onPressed: onPressed,
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text(buttonText ??'', textAlign: TextAlign.center, style: robotoBold.copyWith(color:Theme.of(context).primaryColor,
